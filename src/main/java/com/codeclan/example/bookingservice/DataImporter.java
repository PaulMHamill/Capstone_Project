...
//import reservation.ExtraRepository;
//
...
//                lateCheckoutFee);
//
//        Room room1 = new Room("G1", RoomType.Double, 1, BigDecimal.valueOf(65.12));
//        Room room2 = new Room("G2", RoomType.Double, 1, BigDecimal.valueOf(105.45));
//        Room room3 = new Room("G3", RoomType.Luxury, 1, BigDecimal.valueOf(205.66));
//        Room room4 = new Room("G4", RoomType.Double, 1, BigDecimal.valueOf(35.40));
//
